...
class Can {
    ...
    // const vertex_shader_location = this.gl_context.getAttribLocation(this.shader, "aVertexPosition");
    // this.programInfo = {
    //     attribLocations: {
    //         vertexPosition: , // smh, you're just doing it for sillies now huh
    //         textureCoord: this.gl_context.getAttribLocation(this.shader, ""),
    //     },
    //     uniformLocations: {
    //         projectionMatrix: ,
    //         viewMatrix: ,
